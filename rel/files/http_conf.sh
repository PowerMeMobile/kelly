...
# postpaid originators
post "customers/b5801eb1-d5ed-4a6e-80b4-a9bc35bdb3e9/originators" 'id=eca649a3-fb77-4800-ba5a-0c7c1c14c9fb&address=FromEmail,5,0&description=&is_default=true&state=approved'

# postpaid users
post "customers/b5801eb1-d5ed-4a6e-80b4-a9bc35bdb3e9/users" 'id=user&password=password&connection_types=email&mobile_phone=375296660009&first_name=&last_name=&company=&occupation=&email=email-postpaid@mail.com&country=&language=en&state=active'
...
# prepaid originators
post "customers/01a2d05d-fd2d-4532-847c-16681302101e/originators" 'id=192ebc79-0beb-4e51-be90-548bb1340b66&address=FromEmail,5,0&description=&is_default=true&state=approved'

# prepaid users
post "customers/01a2d05d-fd2d-4532-847c-16681302101e/users" 'id=user&password=password&connection_types=email&mobile_phone=375296660010&first_name=&last_name=&company=&occupation=&email=email-prepaid@mail.com&country=&language=en&state=active'
