...
create_user() ->
	Url = user_path(cst_id()),
	Pswd = {pswd, <<"password">>},
	PermittedTypes = {smpp_types, <<"transmitter;receiver;transceiver">>},
	Queries = [{id, user_id()}],
...
update_user() ->
	Url = user_path(cst_id(), user_id()),
	Pswd = {pswd, <<"new-password">>},
	PermittedTypes = {smpp_types, <<"transmitter">>},
	Queries = [],
