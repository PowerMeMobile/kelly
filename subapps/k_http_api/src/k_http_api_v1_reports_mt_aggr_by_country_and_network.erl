-module(k_http_api_v1_reports_mt_aggr_by_country_and_network).
...
init() ->
    ...
    {ok, #specs{
        read = Read,
        route = "/v1/reports/mt_aggr_by_country_and_network"
    }}.

read(Params) ->
    {ok, k_statistic_mt_aggr_reports:by_country_and_network(Params)}.
