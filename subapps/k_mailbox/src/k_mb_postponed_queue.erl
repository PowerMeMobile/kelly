...
get_current_attempt(Item = #k_mb_incoming{}) ->
    {ok, Item#k_mb_incoming.delivery_attempt}.
...
increment_attempt(Item = #k_mb_incoming{}, Attempt) ->
    Item#k_mb_incoming{delivery_attempt = Attempt + 1}.
